...
[Issue 治理](doc/ISSUES.md) 和 [工程规范](doc/engineering/standards.md)。
...
完整平台说明见 [开发环境指南](doc/contributing/development-environment.md)。
...
### Native Stage 与 NNA native layer
...
- NNA native layer 公共 API 使用 `nna` 命名空间；构建开关和宏使用 `NNA_`。
