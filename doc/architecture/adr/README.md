...
本目录保存会长期影响 NekoPapa/OpenNeko Engine 边界的架构决策。ADR 记录为什么做决定、替代方案、迁移和回滚，不替代 GitHub Issue 的排期与验收。
...
- 更新[运行时边界](../desktop-runtime-boundaries.md)、[迁移计划](../qt-to-tauri-migration.md)或[项目结构](../../OpenNeko%20Engine%20完整项目结构.md)中的受影响部分。
