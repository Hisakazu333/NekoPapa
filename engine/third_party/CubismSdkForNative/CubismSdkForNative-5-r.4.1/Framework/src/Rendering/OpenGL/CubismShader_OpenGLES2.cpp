...
#else
#define CSM_SHADER_VERSION "#version 100\n"
#define CSM_SHADER_PRECISION "precision " CSM_FRAGMENT_SHADER_FP_PRECISION " float;\n"
#endif
...
namespace {
    ...
    const csmChar* VertShaderSrcMasked = 
        CSM_SHADER_VERSION
    ...
    const csmChar* VertShaderSrcSetupMask = 
        CSM_SHADER_VERSION
        "attribute vec4 a_position;\n"
        "attribute vec2 a_texCoord;\n"
        "varying vec2 v_texCoord;\n"
    ...
    const csmChar* FragShaderSrc = 
        CSM_SHADER_VERSION
        CSM_SHADER_PRECISION
        "varying vec2 v_texCoord; //v2f.texcoord\n"
    ...
    const csmChar* FragShaderSrcMask = 
        CSM_SHADER_VERSION
        CSM_SHADER_PRECISION
        "varying vec2 v_texCoord;\n"
        "varying vec4 v_clipPos;\n"
    ...
    const csmChar* FragShaderSrcMaskInverted = 
        CSM_SHADER_VERSION
        CSM_SHADER_PRECISION
        "varying vec2 v_texCoord;\n"
        "varying vec4 v_clipPos;\n"
    ...
    const csmChar* FragShaderSrcPremultipliedAlpha = 
        CSM_SHADER_VERSION
        CSM_SHADER_PRECISION
        "varying vec2 v_texCoord; //v2f.texcoord\n"
        "uniform sampler2D s_texture0; //_MainTex\n"
    ...
    const csmChar* FragShaderSrcMaskPremultipliedAlpha = 
        CSM_SHADER_VERSION
        CSM_SHADER_PRECISION
        "varying vec2 v_texCoord;\n"
        "varying vec4 v_clipPos;\n"
    ...
    const csmChar* FragShaderSrcMaskInvertedPremultipliedAlpha = 
        CSM_SHADER_VERSION
        CSM_SHADER_PRECISION
        "varying vec2 v_texCoord;\n"
        "varying vec4 v_clipPos;\n"
